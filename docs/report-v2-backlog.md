...
Issues found by reviewing the v1 pages on full data (exports in `docs/images/report/`), before the
usability test. The usability findings get added here too, and v2 works through the list.
